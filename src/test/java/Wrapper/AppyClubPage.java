...
public class AppyClubPage {
	...
	public static String title="Home - Appy Club";
	public static String myAccountPageTitle="Appy Club";
...
//	public static String myHistoryValue="No History";
	...
	public static By imgLink=By.xpath("//img[@alt='AppyClub']");
	...
	public static String subMenu2Text="Help";
	public static String subMenu3Text="Contact Us";
	public static String subMenu4Text="Privacy";
	public static String subMenu5Text="Terms";


	public static String footer1Text="My Account";
	public static String footer2Text=subMenu5Text;
	public static String footer3Text=subMenu4Text;
	public static String footer4Text=subMenu2Text;
